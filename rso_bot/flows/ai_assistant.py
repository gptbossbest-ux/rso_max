...
_STRUCTURED_ADDRESS_RE = re.compile(
    ...
    r"[а-яё][а-яё-]{1,}(?:\s+[а-яё][а-яё-]{1,}){0,2}"
    r"|(?!(?:первой|второй|третьей|горячей|холодной|общей|новой|старой|"
    r"такой|этой|каждой|одной|другой)\b)"
    r"(?:мира|победы|[а-яё][а-яё-]*(?:ина|ова|ева|ёва|ского|цкого|"
    r"ская|ское|ской|ной|ой|ей))"
    r")"
